...
void tweakgap( n, k, a, constraints, gap, Z, dZ, y, dy, work1, work2, work3, work4, workvec1, workvec2, workvec3, workvec4, printlevel )
    int                     n;
    int                     k;
    double*                 a;
    ...
    int                     printlevel;
{
    ...
    alpha = linesearch( n, dZ, work1, work2, work3, work4, workvec1, workvec2, workvec3, 1.0, -gap / (norma * norma), 0 );
