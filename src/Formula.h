...
namespace smtrat
{
	enum Type { AND, OR, NOT, IFF, XOR, IMPLIES, BOOL, REALCONSTRAINT, TTRUE, FFALSE };
    ...
    static const Condition WEAK_CONDITIONS                          = PROP_CONTAINS_EQUATION
    ...
    static const Condition SOLVABLE_CONDITIONS                         	= PROP_CANNOT_BE_SOLVED_BY_SIMPLIFIERMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_GROEBNERMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_VSMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_UNIVARIATECADMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_CADMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_SATMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_LRAMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_PREPROMODULE
                                                                          |PROP_CANNOT_BE_SOLVED_BY_PREPROCNFMODULE
                                                                      	  |PROP_CANNOT_BE_SOLVED_BY_CNFERMODULE;
