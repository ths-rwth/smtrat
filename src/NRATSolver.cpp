...
//        strategy().addModuleType( PROP_CANNOT_BE_SOLVED_BY_PREPROMODULE|PROP_IS_NOT_CNF, MT_SATModule );
//        strategy().addModuleType( PROP_CANNOT_BE_SOLVED_BY_PREPROMODULE|PROP_IS_NOT_IN_CNF, MT_TseitinModule );
