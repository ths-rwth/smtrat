...
struct LogicParser: public qi::symbols<char, carl::Logic> {
	LogicParser() {
		...
		add("NRA", carl::Logic::NRA);
		add("LRA", carl::Logic::LRA);
	}
};
struct ErrorHandler {
...
struct ScriptParser: public qi::grammar<Iterator, Skipper> {
		...
		term(&theories)
	{
		...
		command = qi::lit("(") >> (
				(qi::lit("assert-soft") >> term >> ")")[px::bind(&Callee::add, px::ref(callee), qi::_1, true, Rational(1), std::string())]
			|	(qi::lit("assert-soft") >> term >> qi::lit(":weight") >> decimal >> ")")[px::bind(&Callee::add, px::ref(callee), qi::_1, true, qi::_2, std::string())]
			|	(qi::lit("assert-soft") >> term >> qi::lit(":weight") >> decimal >> qi::lit(":id") >> symbol >> ")")[px::bind(&Callee::add, px::ref(callee), qi::_1, true, qi::_2, qi::_3)]
			|	(qi::lit("assert-soft") >> term >> qi::lit(":id") >> symbol >> qi::lit(":weight") >> decimal >> ")")[px::bind(&Callee::add, px::ref(callee), qi::_1, true, qi::_3, qi::_2)]
			|	(qi::lit("assert-soft") >> term >> qi::lit(":id") >> symbol >> ")")[px::bind(&Callee::add, px::ref(callee), qi::_1, true, Rational(1), qi::_2)]
			|	(qi::lit("assert") > term > ")")[px::bind(&Callee::add, px::ref(callee), qi::_1, false, Rational(-1), std::string())]
			...
			|	(qi::lit("get-objectives") > ")")[px::bind(&Callee::getObjectives, px::ref(callee))]
