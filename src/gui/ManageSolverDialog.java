...
public class ManageSolverDialog extends JDialog
{
    ...
    {
        ManageSolverDialog msd = new ManageSolverDialog( gui, solverNameSuggestion );
        return solverName;
    }
    ...
    private void updateAvailableSolvers( String solverName, boolean add )
    {
        ...
        String takeOverText = "Take over this Solver name for exportation.";
    ...
    private class DeleteSolverAction extends AbstractAction
    {
        ...
        public void actionPerformed( ActionEvent ae )
        {
            ...
            int choice = JOptionPane.showConfirmDialog( ManageSolverDialog.this, "Really delete Solver named '" + solverName + "'?", "Question", JOptionPane.YES_NO_OPTION );
            ...
            if( IOTools.deleteSolver( solverName )!=null )
            {
                ...
                JOptionPane.showMessageDialog( ManageSolverDialog.this, "Solver deleted successfully.", "Information", JOptionPane.INFORMATION_MESSAGE );
            }
        }
    }
    ...
    private class ExportSolverAction extends AbstractAction
    {
        ...
        public void actionPerformed( ActionEvent ae )
        {
            ...
            if( existingSolverNameEntered )
            {
                ...
                // Escape = -1, Yes = 0, No = 1, Cancel = 2
                int choice = JOptionPane.showConfirmDialog( ManageSolverDialog.this, "A Solver named '" + textInput + "' already exists. Overwrite this Solver?", "Question", JOptionPane.YES_NO_OPTION );
                if( choice==-1 || choice==1 )
                {
                    return;
                }
