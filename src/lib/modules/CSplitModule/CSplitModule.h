...
namespace smtrat
{
	...
	class CSplitModule : public Module
	{
		private:
            ...
            struct Purification
            {
                vector<carl::Variable> mSubstitutions;
            ...
            map<carl::Monomial::Arg, Purification, greater<carl::Monomial::Arg>> mPurifications;
            ...
            struct Expansion
            {
                ...
                vector<carl::Variable> mQuotients, mRemainders;
                set<Purification *> mPurifications;
            ...
            map<carl::Variable, Expansion> mExpansions;
            
            struct Linearization
            {
                FormulaT mLinearization;
                vector<Purification *> mPurifications;
                size_t mUsage;
                
                Linearization(FormulaT&& linearization, vector<Purification *>&& purifications)
            ...
            map<FormulaT, Linearization> mLinearizations;
