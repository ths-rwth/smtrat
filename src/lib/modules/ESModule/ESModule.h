...
namespace smtrat
{
    ...
    class ESModule : public Module
    {
        ...
        public:
            ESModule( ModuleType _type, const ModuleInput* _formula, RuntimeSettings* _settings, Conditionals& _conditionals, Manager* _manager = NULL );
