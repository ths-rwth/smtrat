...
namespace smtrat
{
     ...
     * Constructor
     */
    ICPModule::ICPModule(ModuleType _type, const Formula* const _formula, RuntimeSettings* settings, Manager* const _tsManager ):
        ...
        mLRA(MT_LRAModule, mValidationFormula, new RuntimeSettings),
        mCenterConstraints(),
        mInitialized(false)
    {
#ifdef HISTORY_DEBUG
