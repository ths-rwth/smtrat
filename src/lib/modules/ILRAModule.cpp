...
#include "ILRAModule.h"
#include <iostream>

//#define DEBUG_ILRA_MODULE
#define ILRA_SIMPLE_THEORY_PROPAGATION
...
namespace smtrat
{
     ...
     * Constructor
     */
    ILRAModule::ILRAModule( const Formula* const _formula, Manager* const _tsManager ):
    ...
    {
        mModuleType = MT_ILRAModule;
    }

    /**
     * Destructor:
     */
    ILRAModule::~ILRAModule()
    {
...
//        }
     ...
     *         True,  otherwise.
     */
    bool ILRAModule::inform( const Constraint* const _constraint )
    {
        #ifdef DEBUG_ILRA_MODULE
...
//        }
     ...
     *         True,  otherwise.
     */
    bool ILRAModule::assertSubformula( Formula::const_iterator _subformula )
    {
...
//        }
     ...
     * @param _subformula The position of the constraint within the received constraints.
     */
    void ILRAModule::removeSubformula( Formula::const_iterator _subformula )
    {
        #ifdef DEBUG_ILRA_MODULE
...
//        }
     ...
     */
    Answer ILRAModule::isConsistent()
    {
//        #ifdef DEBUG_ILRA_MODULE
...
//        }
     ...
     */
    exmap ILRAModule::getRationalModel() const
    {
        exmap result = exmap();
//        if( mInfeasibleSubsets.empty() )
//        {
...
//        }
     ...
     */
    evalintervalmap ILRAModule::getVariableBounds() const
    {
...
//        }
     ...
     */
    void ILRAModule::learnRefinements()
    {
...
//        }
     ...
     */
    void ILRAModule::adaptPassedFormula()
    {
...
//        }
     ...
     *         False, otherwise.
     */
    bool ILRAModule::checkAssignmentForNonlinearConstraint()
    {
...
//        }
     ...
     *         True, otherwise.
     */
    bool ILRAModule::activateBound( const Bound<int>* _bound, set<const Formula*>& _formulas )
    {
        bool result = true;
...
//        }
     ...
     */
    void ILRAModule::setBound( Variable<int>& _var, bool _constraintInverted, const numeric& _boundValue, const Constraint* _constraint )
    {
...
//            #ifdef ILRA_SIMPLE_THEORY_PROPAGATION
...
//        }
     ...
     */
    void ILRAModule::findSimpleConflicts( const Bound<int>& _bound )
    {
...
//            }
//        }
//        #ifdef ILRA_USE_PIVOTING_STRATEGY
