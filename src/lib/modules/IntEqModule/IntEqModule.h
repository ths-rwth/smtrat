...
namespace smtrat
{
    typedef PointerMap<Formula,vector<PointerSet<Formula>>> FormulaOrigins;
    typedef PointerMap<std::pair<carl::Variable, Polynomial>,vector<PointerSet<Formula>>> SubstitutionOrigins;
