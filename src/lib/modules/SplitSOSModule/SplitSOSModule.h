...
namespace smtrat
{
    ...
    class SplitSOSModule : public Module
    {
        private:
            // Members.
            ///
        ...
        public:
            SplitSOSModule( ModuleType _type, const ModuleInput* _formula, RuntimeSettings* _settings, Conditionals& _conditionals, Manager* _manager = NULL );
