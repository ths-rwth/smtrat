...
namespace smtrat
{
    ...
    string BoundMap::constraintToVarMapAsString()
    {
        ...
        for( map<const Constraint*, const ex>::const_iterator iterator = this->constraintToVarMap.begin(); iterator != this->constraintToVarMap.end();
                ++iterator )
        {
    ...
    string BoundMap::varToConstraintMapAsString()
    {
        ...
        for( map<const ex, const Constraint*>::const_iterator iterator = this->varToConstraintMap.begin(); iterator != this->varToConstraintMap.end();
                ++iterator )
        {
            ostringstream osstream;
