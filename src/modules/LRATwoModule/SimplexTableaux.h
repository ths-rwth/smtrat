...
namespace smtrat
{
    class SimplexTableaux:
        public map<int, map<int, numeric> >
    {
        public:
            SimplexTableaux();
            ...
            bool assertStrictUpper( const Constraint* const _constraintNew,
                                    const Constraint* const _constraintOld,
                                    Bound* newBound,
                                    Bound* oldBound,
                                    BoundMap* boundMap,
                                    BetaMap* betaMap );
            bool assertStrictLower( const Constraint* const _constraintNew,
                                    const Constraint* const _constraintOld,
                                    Bound* newBound,
                                    Bound* oldBound,
                                    BoundMap* boundMap,
                                    BetaMap* betaMap );
            bool assertUpper( const Constraint* const _constraintNew,
                              const Constraint* const _constraintOld,
                              Bound* newBound,
                              Bound* oldBound,
                              BoundMap* boundMap,
                              BetaMap* betaMap );
            bool assertLower( const Constraint* const _constraintNew,
                              const Constraint* const _constraintOld,
                              Bound* newBound,
                              Bound* oldBound,
                              BoundMap* boundMap,
