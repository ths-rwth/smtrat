...
struct MccallumPdelSettings {
    static constexpr bool complete = false;
};

struct MccallumPdelSettingsComplete : MccallumPdelSettings {
...
using PropertiesSet = datastructures::PropertiesT<properties::poly_sgn_inv,properties::poly_irreducible_sgn_inv,properties::poly_semi_sgn_inv,properties::poly_ord_inv,properties::poly_del,properties::poly_proj_del,properties::cell_connected,properties::poly_constraint_truth_inv,properties::iroot_constraint_truth_inv>;
