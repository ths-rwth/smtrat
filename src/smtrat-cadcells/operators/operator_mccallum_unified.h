...
struct MccallumUnifiedSettings {
    ...
    static constexpr bool pdel = false;
};

struct MccallumUnifiedSettingsComplete : MccallumUnifiedSettings {
    static constexpr bool complete = true;
};

struct MccallumUnifiedSettingsCompletePdel : MccallumUnifiedSettings {
    static constexpr bool complete = true;
    static constexpr bool pdel = true;
};
    

template<typename Settings>
struct MccallumUnified {

static constexpr bool filter = true;

using PropertiesSet = datastructures::PropertiesT<properties::poly_sgn_inv,properties::poly_irreducible_sgn_inv,properties::poly_semi_sgn_inv,properties::poly_irreducible_semi_sgn_inv,properties::poly_ord_inv,properties::poly_del,properties::cell_connected,properties::poly_ord_inv_base,properties::root_ordering_holds,properties::poly_constraint_truth_inv,properties::iroot_constraint_truth_inv,properties::poly_proj_del>;
