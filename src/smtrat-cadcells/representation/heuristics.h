...
enum CellHeuristic {
	...
	OPTIMAL_FEATURE_BASED2,
	OPTIMAL_VARIABLE_DEPTH2,
	OPTIMAL_TOTAL_DEGREE_UPPER_BOUND2,
	OPTIMAL_TOTAL_DEGREE_EXACT2,
	OPTIMAL_SUM_OVER_TOTAL_DEGREE2,
	OPTIMAL_NUM_VARIABLES2,
	OPTIMAL_NUM_RESULTANTS2,
	OPTIMAL_NUM_MONOMIALS2
};
