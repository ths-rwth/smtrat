...
namespace smtrat {
    ...
    #else
        #define SMTRAT_VALIDATION_INIT(channel, name, variable)
        #define SMTRAT_VALIDATION_INIT_STATIC(channel, name, variable)
        #define SMTRAT_VALIDATION_ADD_TO(variable, formula, consistent)
