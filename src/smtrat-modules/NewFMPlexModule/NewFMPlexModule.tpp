...
template<class Settings>
void NewFMPlexModule<Settings>::set_level(std::size_t index, const fmplex::Level& level) {
...
template<class Settings>
bool NewFMPlexModule<Settings>::process_conflict(fmplex::Conflict conflict) {
