...
struct CoveringNGSettings : CoveringNGSettingsDefault  {
    struct formula_evaluation {
        ...
        static auto create(cadcells::datastructures::Projections& proj) {
            ...
            auto fe_constraint_ordering = covering_ng::formula::complexity::min_sotd;
...
class CoveringNG_PPBooleanPartialPropagationSotd: public Manager {
public:
	CoveringNG_PPBooleanPartialPropagationSotd() : Manager() {
		setStrategy(
