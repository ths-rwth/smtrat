...
struct CoveringNGSettings : CoveringNGSettingsDefault  {
    struct formula_evaluation {
        ...
        static auto create(cadcells::datastructures::Projections& proj) {
            auto fe_implicant_ordering = covering_ng::formula::complexity::min_level_min_size;
...
class CoveringNG_PPImplicantsLevelSize: public Manager {
public:
	CoveringNG_PPImplicantsLevelSize() : Manager() {
		setStrategy(
