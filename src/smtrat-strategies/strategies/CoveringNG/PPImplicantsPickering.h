...
struct CoveringNGSettings : CoveringNGSettingsDefault  {
    struct formula_evaluation {
        ...
        static auto create(cadcells::datastructures::Projections& proj) {
            auto fe_implicant_ordering = covering_ng::formula::complexity::pickering;
...
class CoveringNG_PPImplicantsPickering: public Manager {
public:
	CoveringNG_PPImplicantsPickering() : Manager() {
		setStrategy(
