...
struct CoveringNGSettings : CoveringNGSettingsBase  {
    struct formula_evaluation {
        ...
        static auto create(cadcells::datastructures::Projections& proj) {
            auto fe_implicant_ordering = covering_ng::formula::complexity::min_max_tdeg_min_size;
...
class CoveringNG_PPImplicantsTdeg: public Manager {
public:
	CoveringNG_PPImplicantsTdeg() : Manager() {
		setStrategy(
