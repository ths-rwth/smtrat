 ...
 *
 */
class DefaultNew : public Manager {
        ...
        setStrategy({
            ...
            addBackend<FPPModule<FPPSettings1>>({
                addBackend<STropModule<STropSettings3>>({
                    addBackend<SATModule<SATSettingsMCSATBCApxVSIDS>>().condition(&condition_qf_nra_with_bool),
                    addBackend<SATModule<SATSettingsMCSATBCApxStaticTheory>>().condition(&condition_qf_nra_without_bool)
                })
