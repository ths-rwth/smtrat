...
struct CoveringNGSettings : CoveringNGSettingsDefault  {
	...
	struct formula_evaluation {
        ...
        static auto create(cadcells::datastructures::Projections& proj) {
            auto fe_implicant_ordering = covering_ng::formula::complexity::sotd_reverse;
            ...
            auto fe_boolean_exploration = covering_ng::formula::GraphEvaluation::Evaluation;
...
class Eval_CalcPpRevsotd : public Manager {
public:
	Eval_CalcPpRevsotd() : Manager() {
		setStrategy(
