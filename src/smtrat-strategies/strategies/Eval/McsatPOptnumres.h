...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::NUM_RESULTANTS>;
...
class Eval_McsatPOptnumres : public Manager {
public:
	Eval_McsatPOptnumres() : Manager() {
		setStrategy(
