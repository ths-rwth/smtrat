...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::SUM_OF_TOTAL_DEGREES>;
...
class Eval_McsatPOptsotd : public Manager {
public:
	Eval_McsatPOptsotd() : Manager() {
		setStrategy(
