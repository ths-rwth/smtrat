...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::ChainEq;
	using covering_heuristic = cadcells::representation::covering_heuristics::ChainCovering;
...
class Eval_McsatVsidsPChain : public Manager {
public:
	Eval_McsatVsidsPChain() : Manager() {
		setStrategy(
