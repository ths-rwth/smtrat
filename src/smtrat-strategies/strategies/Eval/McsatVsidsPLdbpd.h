...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::LowestDegreeBarriersFilterPdel;
	using covering_heuristic = cadcells::representation::covering_heuristics::LowestDegreeBarriersCoveringFilterPdel;
...
class Eval_McsatVsidsPLdbpd : public Manager {
public:
	Eval_McsatVsidsPLdbpd() : Manager() {
		setStrategy(
