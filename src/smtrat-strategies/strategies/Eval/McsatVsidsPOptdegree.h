...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::DEGREE>;
...
class Eval_McsatVsidsPOptdegree : public Manager {
public:
	Eval_McsatVsidsPOptdegree() : Manager() {
		setStrategy(
