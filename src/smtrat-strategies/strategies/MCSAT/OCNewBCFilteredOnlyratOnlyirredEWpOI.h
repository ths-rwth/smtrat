...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	constexpr static auto op = cadcells::operators::op::mccallum_filtered_onlyrat_onlyirred_ew;
};
...
class MCSAT_OCNewBCFilteredOnlyratOnlyirredEWpOI : public Manager {
public:
	MCSAT_OCNewBCFilteredOnlyratOnlyirredEWpOI()
		: Manager() {
		setStrategy(
