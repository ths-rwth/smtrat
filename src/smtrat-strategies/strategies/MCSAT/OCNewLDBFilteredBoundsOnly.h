...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	constexpr static auto op = cadcells::operators::op::mccallum_filtered_bounds_only;
};
...
class MCSAT_OCNewLDBFilteredBoundsOnly : public Manager {
public:
	MCSAT_OCNewLDBFilteredBoundsOnly()
		: Manager() {
		setStrategy(
