...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::FEATURE_BASED>;
...
class MCSAT_OCNewOptimalFB : public Manager {
public:
	MCSAT_OCNewOptimalFB()
		: Manager() {
		setStrategy(
