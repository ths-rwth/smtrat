...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	constexpr static auto cell_heuristic = cadcells::representation::OPTIMAL_SUM_OVER_TOTAL_DEGREE2;
...
class MCSAT_OCNewOptimalSOTD2 : public Manager {
public:
	MCSAT_OCNewOptimalSOTD2()
		: Manager() {
		setStrategy(
