...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::TOTAL_DEGREE_EXACT>;
...
class MCSAT_OCNewOptimalTDE : public Manager {
public:
	MCSAT_OCNewOptimalTDE()
		: Manager() {
		setStrategy(
