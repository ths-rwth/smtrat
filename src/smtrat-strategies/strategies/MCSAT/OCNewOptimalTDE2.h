...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	constexpr static auto cell_heuristic = cadcells::representation::OPTIMAL_TOTAL_DEGREE_EXACT2;
...
class MCSAT_OCNewOptimalTDE2 : public Manager {
public:
	MCSAT_OCNewOptimalTDE2()
		: Manager() {
		setStrategy(
