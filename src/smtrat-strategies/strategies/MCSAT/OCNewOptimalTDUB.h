...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::TOTAL_DEGREE_UPPER_BOUND>;
...
class MCSAT_OCNewOptimalTDUB : public Manager {
public:
	MCSAT_OCNewOptimalTDUB()
		: Manager() {
		setStrategy(
