...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	constexpr static auto cell_heuristic = cadcells::representation::OPTIMAL_TOTAL_DEGREE_UPPER_BOUND2;
...
class MCSAT_OCNewOptimalTDUB2 : public Manager {
public:
	MCSAT_OCNewOptimalTDUB2()
		: Manager() {
		setStrategy(
