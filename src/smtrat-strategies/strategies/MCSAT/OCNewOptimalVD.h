...
struct OCSettings : smtrat::mcsat::onecell::BaseSettings {
	...
	using cell_heuristic = cadcells::representation::cell_heuristics::CombinatorialOptimization<cadcells::representation::combinatorialopt::ResultantCostMetric::VARIABLE_DEPTH>;
...
class MCSAT_OCNewOptimalVD : public Manager {
public:
	MCSAT_OCNewOptimalVD()
		: Manager() {
		setStrategy(
